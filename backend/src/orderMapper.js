...
export function buildOrderPayload(input, options) {
  ...
  return {
    orderData: {
      ...
      steelCategory: nullableText(source.steelCategory),
      galvanizingProcess: nullableText(source.galvanizingProcess),
      deliveryMethod: nullableText(source.deliveryMethod),
